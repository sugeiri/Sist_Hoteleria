...
{
    public partial class Conf_C_CaractTHabitacion : Form
    {
        ...
        public Conf_C_CaractTHabitacion(string ii_modo)
        {
            InitializeComponent();
            aa_modo = ii_modo;
        }
        public Conf_C_CaractTHabitacion(string ii_sql, string ii_modo)
        {
            InitializeComponent();
            aa_modo = ii_modo;
            sql = ii_sql;
        ...
        private void Conf_C_CaractTHabitacion_Load(object sender, EventArgs e)
        {
