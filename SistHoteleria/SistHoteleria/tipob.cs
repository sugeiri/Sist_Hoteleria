...
{
    public partial class tipob : Form
    {
        string aa_tabla = "";
        string aa_titulo = "";
        string aa_modo = "c";
        ...
        public tipob(string ii_modo, string ii_tabla, string ii_titulo)
        {
            InitializeComponent();
        ...
        public tipob(string ii_modo, string ii_tabla, string ii_titulo, string ii_query)
        {
            InitializeComponent();
        ...
        private void tipob_Load(object sender, EventArgs e)
        {
            Lee_Datos();
        }
        void Lee_Datos()
